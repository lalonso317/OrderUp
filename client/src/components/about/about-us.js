    ...
    <div className="about-us-page-container">
      ...
      <div className="about-us-page-subtitle">
        ...
        <div className="about-us-page-content">
          ...
          <p>
            The story of Order Up is a classic example of 3 friends with passion
            of discovering new and excited dishes to try out.
          </p>
          <p>
      ...
      <div className="about-us-page-subtitle">
        ...
        <div className="about-us-page-content">
          ...
          <p>
            Our goal is to branch out and to make this site available to several
            different countries and discover dishes that people would not have
            access to otherwise.
          </p>
        </div>
      </div>
